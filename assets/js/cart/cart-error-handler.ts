...
export class CartErrorHandler {
   ...
   */
  private static processError(error: any, context: ErrorContext): {
    type: string;
    message: string;
    status?: number;
    retry?: boolean;
  ...
  public static handleError(
    ...
    if (this.debugMode) {
      console.error(
        `[CartErrorHandler] ${processedError.type} (${context.component}/${context.method || context.operation}):`, 
